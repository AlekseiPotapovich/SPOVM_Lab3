...
void Server(char* path)
{
	...
	Semaphores[0] = CreateSemaphore(NULL, 0, 1, "SEMAPHORE");      // Семафор, уведомляющий о разрешении печати
	Semaphores[1] = CreateSemaphore(NULL, 0, 1, "SEMAPHORE_end");      // Семафор, уведомляющий о разрешении печати
	Semaphores[2] = CreateSemaphore(NULL, 0, 1, "SEMAPHORE_EXIT");	// Семафор, уведомляющий о завершении работы			
